"""
Demo: Use native MemoryManager (C++ via pybind) to map a file and prefetch chunks.
This showcases the offload/prefetch API independent of HF.

Usage (PowerShell):
  python -m pylittle.tools.demo_native_mm -Path path\to\bigfile.bin -Offset 0 -Bytes 1048576
"""
